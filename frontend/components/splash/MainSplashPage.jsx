...
const MainSplashPage = () => (
  <div className="splash-images-container">
    ...
    <img className="monitor" src="https://discordapp.com/assets/0d82411c439e3558f8b2f6fb12eccbc1.svg" alt="monitor with discord open" />
    <img className="disc" src="https://discordapp.com/assets/15149ecb9d5cd8faa24e1bbf45d70e5b.svg" alt="disc" />
    <img className="square-phone" src="https://discordapp.com/assets/5a31f41848bf3ba1817a092ac28c623d.svg" alt="phone with discord open" />
    <img className="round-phone" src="https://discordapp.com/assets/82fa4f388cfc9cf47a6972ae39ae90de.svg" alt="different phone with another part of discord open" />
    <img className="game-controller" src="https://discordapp.com/assets/c4bae281354a2b4e2db85415955e0994.svg" alt="game controller" />
    <img className="laptop" src="https://discordapp.com/assets/7edaed9d86e1b5dd9d4c98484372222b.svg" alt="loptop with discord open" />
    <img className="headphones" src="https://discordapp.com/assets/69db64955960eb333f5ff831cc1c0294.svg" alt="headphones that are hanging off the middle of the laptop" />
  </div>
);
